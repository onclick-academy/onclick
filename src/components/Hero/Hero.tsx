  ...
  return (
    <div id='#' className='h-auto px-14'>
      ...
      <div className='absolute top-[40%] z-0'>
        <Image src={Shape1} alt='shape1' width={600} height={600} className='z-0' />
      </div>
      <div className='hidden lg:block absolute right-0 z-0'>
        <Image src={Shape2} alt='shape2' className='z-0' />
      </div>
      <div className='container mx-auto flex flex-col lg:flex-row gap-8 lg:gap-0 items-center py-20'>
        <div className='flex-1 order-2 lg:order-1'>
          <div className='flex gap-4 lg:gap-16 flex-col lg:flex-row pb-12'>
            <div className='flex flex-col items-center md:items-start gap-3'>
              <Stars fill={4} half={1} size={24} color='#FF8F3C' />
              <p className='font-semibold '>12500+ TRUST STUDENTS</p>
            </div>

            <div className='flex flex-col items-center md:items-start gap-3'>
              <Badge fill='#FF8F3C' stroke='#FF8F3C' className='mx-auto md:mr-0 md:ml-0' />
        ...
        <div className='flex-1 flex justify-center lg:order-1 z-0'>
          <Image src={HeroBanner} alt='Hero banner section' />
        </div>
      </div>
    </div>
  )
