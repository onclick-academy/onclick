  ...
  return (
    <div className='flex items-center max-lg:flex-col max-lg:gap-8 py-20'>
      ...
      <div className='absolute top-[40%]'>
        <Image src={Shape1} width={500} height={500} alt='shape1' />
      </div>
      ...
      <div className='flex-1 max-lg:order-2'>
        <div className='flex gap-16 pb-12'>
          ...
          <div className='flex flex-col gap-3'>
            <Badge fill='#FF8F3C' stroke='#FF8F3C' />
        ...
        <h6 className='font-light'>
          The most <span className='font-semibold underline underline-offset-2'>powerful</span> yet the{' '}
          <span className='font-semibold underline underline-offset-2'>easiest</span> template ever.
        </h6>
      </div>

      <div className='flex-1 flex justify-center max-lg:order-1 z-[2]'>
        <Image src={HeroBanner} width={500} height={500} alt='Hero banner section' />
      </div>
    </div>
  )
}
