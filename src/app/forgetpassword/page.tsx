...
//     </h2>
//     {loginError && <FormDescription className='text-red-500'>{loginError}</FormDescription>}
//     <form onSubmit={handleSubmit(()=>{})} className='w-3/3 space-y-6'>
//       <FormField
//         control={control}
//         name='code'
//         render={({ field }) => (
...
//               value={codeValue} // set the value to the watched codeValue
//               onChange={(value: string) => setValue('code', value, { shouldValidate: true })} // update the value with setValue
//             >
//               <InputOTPGroup>
...
//       />
//       <div className='flex justify-end'>
//         <Button className='bg-primary hover:bg-septenary m-1' type='submit'>
//           Send
//         </Button>
